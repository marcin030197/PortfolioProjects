...
-- Uzycie funkcji agregujacej Max do wyznaczenia najwiekszej i najmniejszej wartosci Life_expectancy i pogrupowaniu wedlug statusu
...
--Uzycie partycji do wyznaczenia maksymalnej wartosci life_expectancy i obliczeniu iloœci kraji posiadajacych ten wynik, zapytanie wskazuje te¿ nazwy krajow spelniajace te warunki
...
-- Tworze nowa tabele tymczasowa w ktorej bede sumowal rankingi
...
-- W 2015 roku krajwm o najwyzszym wskazniku Life expectancy i Happiness Rank byla Dania
...
-- T-SQL
-- Wyswietlenie nazwy kraju ktory uzyskal najwyzszym wspolczynnik szczescia i najdluzsza oczekiwana dlugosc zycia w 2015 roku
